...
class Main extends PluginBase{
	...
	public const PREFIX = TextFormat::GRAY . TextFormat::BOLD . "(" . TextFormat::PINK . "Xeronix" . TextFormat::GRAY . "Network" . TextFormat::GRAY . ") " . TextFormat::RESET;
	...
	public function onEnable() : void{
		...
		$this->getServer()->getCommandMap()->registerAll("Chalix", [
